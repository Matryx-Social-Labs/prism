...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;">Your one-time Parse sign-in link — expires in {ttl_min} minutes.</div>
...
<tr><td align="center">
  <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="max-width:480px;width:100%;background:{_CARD};border:1px solid {_LINE};border-radius:16px;overflow:hidden;">
    ...
    <tr><td style="padding:36px 40px 40px;">
      <div style="font-family:{_SERIF};font-size:22px;font-weight:600;color:{_INK};letter-spacing:-0.01em;">Parse</div>
      <h1 style="margin:22px 0 0;font-family:{_SERIF};font-size:26px;line-height:1.2;font-weight:600;color:{_INK};">Sign in to Parse</h1>
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px 0 8px;">
        <tr><td style="border-radius:999px;background:{_INK};">
          <a href="{safe_link}" style="display:inline-block;padding:13px 28px;font-family:{_SANS};font-size:15px;font-weight:600;color:{_CARD};text-decoration:none;border-radius:999px;">Sign in to Parse</a>
        </td></tr>
      </table>
      ...
      <p style="margin:16px 0 0;font-family:{_SERIF};font-size:13px;color:{_FAINT};">Parse — One story. Every perspective.</p>
    </td></tr>
  </table>
</td></tr>
</table>
