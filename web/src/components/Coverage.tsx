...
import { ORIGINS, ORIGIN_LABEL, coverageCounts, coverageText, languageNames, languagesOf, publishers, type Origin } from "@/lib/coverage";

export { ORIGINS, ORIGIN_LABEL, coverageCounts, coverageText, languageNames, languagesOf, publishers, type Origin };
